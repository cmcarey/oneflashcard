...
if (!portStr) throw new Error("Missing env var PORT");
...
if (!db_pass) throw new Error("Missing env var DB_PASS");

// DB_DATABASE env var
const db_database = process.env.DB_DATABASE;
if (!db_database) throw new Error("Missing env var DB_DATABASE");
